<?php $__env->startSection('title', 'Add Vendor | PPMS'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('name')); ?>" placeholder="e.g., ABC Construction Supplies Ltd"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('registration_number')); ?>" placeholder="e.g., RC123456">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('phone')); ?>" placeholder="+234 XXX XXX XXXX" required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('alt_phone')); ?>" placeholder="+234 XXX XXX XXXX">
...
unset($__errorArgs, $__bag); ?>"
                                        rows="2" required><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                        x-model="selectedState" @change="loadLgas()" required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <template x-for="lga in lgas" :key="lga.id">
                                            <option :value="lga.id" x-text="lga.lga"
                                                :selected="lga.id == <?php echo e(old('lga_id') ?? 'null'); ?>"></option>
                                        </template>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('account_number')); ?>" placeholder="10 digits">
...
unset($__errorArgs, $__bag); ?>"
                                        required>
                                        <option value="active"
                                            <?php echo e(old('status', 'active') === 'active' ? 'selected' : ''); ?>>Active</option>
...
unset($__errorArgs, $__bag); ?>"
                                        rows="3"
                                        placeholder="Any additional notes about this vendor..."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="<?php echo e(route('vendors.index')); ?>" class="btn btn-light">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Ahmadx/Downloads/ppms/resources/views/vendors/create.blade.php ENDPATH**/ ?>