...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="form-head d-flex mb-4 align-items-start">
            <div class="mr-auto">
                <h3 class="text-orange font-w600">Welcome to <?php echo e(config('app.short_name')); ?>, <span
                        class="text-orange"><?php echo e(Auth::user()->firstname. ' ' .Auth::user()->lastname); ?>!</span></h3>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Ahmadx/Downloads/ppms/resources/views/dashboard/index.blade.php ENDPATH**/ ?>