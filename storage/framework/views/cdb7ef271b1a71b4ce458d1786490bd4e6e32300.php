            ...
            <div class="col-lg-8">
                ...
                <div class="card mt-4">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                        ...
                        <?php if(auth()->user()->can('update', $project) || auth()->user()->hasPermission('view-request-pricing')): ?>
                    ...
                    <div class="card-body p-0">
                        <?php if($project->expenses && $project->expenses->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $project->expenses->sortByDesc('expense_date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($expense->expense_date->format('M d, Y')); ?></td>
                                        <td>
                                            <span class="badge badge-subtle-secondary text-secondary">
                                                <?php echo e(ucwords(str_replace('_', ' ', $expense->expense_type))); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e(Str::limit($expense->description, 30)); ?></td>
                                        <td>
                                            <small><?php echo e(optional($expense->recordedBy)->firstname ?? 'N/A'); ?></small>
                                        </td>
                                        <td class="text-end fw-bold">₦<?php echo e(number_format($expense->amount, 2)); ?></td>
                                        <td class="text-center">
                                            <?php if($expense->receipt_path): ?>
                                            <a href="<?php echo e(route('projects.expenses.receipt.view', $expense)); ?>" target="_blank"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-0">
                            ...
                            <p class="small mb-0"><?php echo e($project->description ?? 'No description.'); ?></p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card border h-100">
                                    ...
                                    <div style="height: 150px; overflow: hidden; background-color: #f8f9fa;"
                                        ...
                                        <img src="<?php echo e(route('projects.attachment.view', ['project' => $project, 'index' => $index])); ?>" class="card-img-top"
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-group">
                                                <a href="<?php echo e(route('projects.attachment.view', ['project' => $project, 'index' => $index])); ?>" target="_blank"
...
<div class="modal fade" id="addExpenseModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('projects.expenses.store', $project)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="expense_date" class="form-control" required
                            max="<?php echo e(date('Y-m-d')); ?>" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Ahmadx/Downloads/archillery/resources/views/projects/show.blade.php ENDPATH**/ ?>