<?php $__env->startSection('title', 'Edit Project | PPMS'); ?>
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="<?php echo e(route('projects.show', $project)); ?>"><?php echo e($project->code); ?></a></li>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($project->code); ?>" readonly
                                        disabled>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="<?php echo e($state->id); ?>"
                                            <?php echo e(old('state_id', $project->state_id) == $state->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <template x-for="lga in lgas" :key="lga.id">
                                            <option :value="lga.id" x-text="lga.lga"
                                                :selected="lga.id == <?php echo e(old('lga_id', $project->lga_id ?? 'null')); ?>">
                                            </option>
                                        </template>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('budget', $project->budget)); ?>" step="0.01" min="0">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('start_date', $project->start_date?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('end_date', $project->end_date?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="planning"
                                            <?php echo e(old('status', $project->status) === 'planning' ? 'selected' : ''); ?>>
                                            Planning</option>
                                        <option value="active"
                                            <?php echo e(old('status', $project->status) === 'active' ? 'selected' : ''); ?>>Active
                                        </option>
                                        <option value="on_hold"
                                            <?php echo e(old('status', $project->status) === 'on_hold' ? 'selected' : ''); ?>>On
                                            Hold</option>
                                        <option value="completed"
                                            <?php echo e(old('status', $project->status) === 'completed' ? 'selected' : ''); ?>>
                                            Completed</option>
                                        <option value="cancelled"
                                            <?php echo e(old('status', $project->status) === 'cancelled' ? 'selected' : ''); ?>>
                                            Cancelled</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="<?php echo e($manager->id); ?>"
                                            <?php echo e(in_array($manager->id, old('site_managers', $assignedSiteManagers)) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="<?php echo e($officer->id); ?>"
                                            <?php echo e(in_array($officer->id, old('procurement_officers', $assignedProcurementOfficers)) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="<?php echo e(route('projects.show', $project)); ?>" class="btn btn-light">
...
function projectForm() {
    return {
        selectedState: '<?php echo e(old("state_id", $project->state_id)); ?>',
        selectedLga: '<?php echo e(old("lga_id", $project->lga_id)); ?>',
        lgas: <?php echo json_encode($lgas, 15, 512) ?>,
        lgasLoading: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Ahmadx/Downloads/archillery/resources/views/projects/edit.blade.php ENDPATH**/ ?>