    ...
    <div class="row min-vh-100 g-0">
        ...
        <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center login-bg">
            <div class="text-center px-5">
                <br><br><br><br><br>
                <img src="<?php echo e(asset('/images/logo.png')); ?>" class="mb-3" style="width: 220px;">
                <img src="<?php echo e(asset('/images/logo-text.png')); ?>" style="width: 300px;">
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <small class="text-dark text-center d-block mb-2">
                    &copy; <?php echo e(date("Y")); ?>. AMS Herald Project Procurement Management System. All rights reserved.
                </small>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Ahmadx/Downloads/ppms/resources/views/auth/login.blade.php ENDPATH**/ ?>