                ...
                <div class="row justify-content-center h-100 align-items-center">
                    <div class="col-md-5">
                        <div class="form-input-content text-center error-page">
                            ...
                            <h4><i class="fa fa-exclamation-triangle text-warning"></i> The page you were looking for is
                                not found!</h4>
                            <p>You may have mistyped the address or the page may have moved.</p>
                            <div>
                                <a class="btn btn-secondary" href="<?php echo e(url('/')); ?>">Back to Home</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH /Users/Ahmadx/Downloads/ppms/resources/views/errors/404.blade.php ENDPATH**/ ?>