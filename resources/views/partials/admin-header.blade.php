...
<div class="nav-header">
    <a href="{{ url('/') }}" class="brand-logo">
        ...
        <img class="brand-title logo-light" src="{{ asset('/images/logo-text-dark.png') }}" alt="">

        <!-- Dark mode logo (light logo image) -->
        <img class="brand-title logo-dark" src="{{ asset('/images/logo-text-light.png') }}" alt="">
    </a>
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right font-sans">
                    ...
                    <li class="nav-item">
                        <a class="btn  btn-secondary mr-4" href="{{ route('register') }}">{{ __('Register') }}</a>
                    </li>
                    @endif
                    @else
                    <!-- Theme Toggle -->
                    ...
                    <li class="nav-item dropdown notification_dropdown" x-data="notifications()"> <a
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow-lg" :class="{ 'show': dropdownOpen }"
                            ...
                            <div class="dropdown-divider"></div> <a href="{{ route('notifications') }}"
                    ...
                    <li class="nav-item dropdown header-profile"> <a class="nav-link" href="javascript:;" role="button"
                            ...
                            src="{{ asset('storage/profile/'.Auth::user()->photo) }}" @else
                            src="https://www.pngfind.com/pngs/m/610-6104451_image-placeholder-png-user-profile-placeholder-image-png.png"
                            @endif width="20" alt="avatar"> <div class="header-info"> <span>
                                    {{ Auth::user()->firstname.' '.Auth::user()->lastname  }}</span>
                            </div> </a>
                        <div class="dropdown-menu dropdown-menu-right"> <a href="{{ route('profile') }}"
                                ...
                                </svg> <span class="ml-2">{{ __('Logout') }} </span> </a>
