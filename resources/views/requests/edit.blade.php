...
@section('title', 'Edit Procurement Request | PPMS')
...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row" x-data="requestEditCart({{ $request->id }})">
            <div class="col-lg-8">
                <!-- Request Information -->
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning mb-3">
                            ...
                            <strong>Request #{{ $request->request_number }}</strong> - Only draft requests can be edited
                        </div>
...
<script>
    function requestEditCart(requestId) {
        return {
            ...
            requiredByDate: '{{ $request->required_by_date ? $request->required_by_date->format("Y-m-d") : "" }}',
            ...
            async updateRequest() {
                ...
                try {
                    ...
                    const response = await fetch('{{ route("requests.update", $request) }}', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        setTimeout(() => {
                            window.location.href = '{{ route("requests.show", $request) }}';
                        }, 1000);
                    } else {
