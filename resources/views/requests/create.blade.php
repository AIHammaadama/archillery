...
@section('title', 'Create Procurement Request | PPMS')
...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="row" x-data="requestCart({{ $selectedProjectId ?? 'null' }})">
            <div class="col-lg-8">
                <!-- Request Information -->
                <div class="card mb-3">
                        ...
                        <div class="d-md-none mb-3">
                            ...
                            <div class="category-chips-container">
                                <div class="category-chips">
                                    ...
                                    @foreach($categories as $cat)
                                    <button type="button"
                                        :class="['btn btn-sm category-chip', selectedCategory === '{{ $cat }}' ? 'btn-primary' : 'btn-outline-secondary']"
                                        @click="selectedCategory = '{{ $cat }}'; searchMaterials()">
                                        {{ $cat }}
                                    </button>
                                    @endforeach
                                </div>
            ...
            async submitRequest() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        window.location.href = result.redirect_url || '{{ route("requests.index") }}';
                    } else {
