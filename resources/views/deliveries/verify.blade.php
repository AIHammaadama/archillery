...
@section('title', 'Verify Delivery | PPMS')
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('deliveries.show', $delivery) }}">{{ $delivery->delivery_number }}</a></li>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="mb-0">{{ number_format($delivery->requestItem->quantity, 2) }}
                                {{ $delivery->requestItem->material->unit_of_measurement }}</p>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('deliveries.process-verification', $delivery) }}" method="POST" class="ajax-form">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check mb-3 p-3 border rounded">
                                    <input class="form-check-input" type="radio" name="verification_status"
                                        ...
                                        {{ old('verification_status') === 'accepted' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check mb-3 p-3 border rounded">
                                    <input class="form-check-input" type="radio" name="verification_status"
                                        ...
                                        {{ old('verification_status') === 'partial' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check mb-3 p-3 border rounded">
                                    <input class="form-check-input" type="radio" name="verification_status"
                                        ...
                                        {{ old('verification_status') === 'rejected' ? 'checked' : '' }} required>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="quality_notes"
                                    class="form-control @error('quality_notes') is-invalid @enderror" rows="4"
                                    placeholder="Add notes about quality, condition, compliance with specifications, issues found, etc.">{{ old('quality_notes') }}</textarea>
