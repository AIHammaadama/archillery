    ...
    <div class="row min-vh-100 g-0 login-bg">
        ...
        <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center">
            <div class="text-center px-5">
                <br><br><br>
                <img src="{{ asset('/images/logo-login.png') }}" style="width: 500px;">
            </div>
        </div>
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center bg-info-light ">
            <div class="w-100" style="max-width: 400px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3 text-end">
                                ...
                                <a href="{{ route('password.request') }}" class="text-danger" style="font-size: 14px;">
                                    Forgot password?
                                </a>
                                @endif
                            </div>
                ...
                <small class="text-dark text-center d-block mb-2">
                    &copy; {{ date("Y") }}. Archillery Build Project & Procurement Management System. All rights
                    reserved.
                </small>
            </div>
        </div>
